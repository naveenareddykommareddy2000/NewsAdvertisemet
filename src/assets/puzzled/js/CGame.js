function CGame(iDifficulty,oData){
    ...
    this._init = function(iDifficulty){
        ...
        // alert("Image chosen was " + _szImage);
        TEXT_CAPTION = IMAGECAPTIONS[(_szImage.charAt(6)-1)];
        // alert("Image caption is " + TEXT_CAPTION);
        TEXT_LINK = IMAGELINKS[(_szImage.charAt(6)-1)];
    ...
    this._createShufflePoints = function(){
        ...
        var oLeftRect = new createjs.Rectangle(BOARD_X - 100,BOARD_Y+100,100,BOARD_Y+500);
        var oRightRect = new createjs.Rectangle(BOARD_X + IMAGE_WIDTH + 10,BOARD_Y+100,100,BOARD_Y+500);

        _aShufflePoints = new Array();
        for(var i=0;i<_iNumPieces/2;i++){
            var iRandX = Math.floor(Math.random() * ( (oLeftRect.x+oLeftRect.width) - oLeftRect.x + 100)) + oLeftRect.x;
            ...
            var iRandX = Math.floor(Math.random() * ( (oRightRect.x+oLeftRect.width) - oRightRect.x + 100)) + oRightRect.x;
